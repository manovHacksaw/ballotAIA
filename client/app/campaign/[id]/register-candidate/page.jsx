...
const RegisterCandidate = ({ params }) => {
    const { connectWallet, registerAsCandidate, isConnected, account, loading, balance, getCampaignById, isCandidateRegistered } = useVoting();
    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-r p-6 relative">
            ...
            {event && <h2 className="text-2xl font-bold text-white mb-6">Register as a Candidate for {event.name}</h2>}
